    ...
    <div className="my-4 overflow-hidden rounded-[3px] border border-cyan/30 bg-void-elevated/70 backdrop-blur-sm">
      <div className="flex items-center justify-between border-b border-cyan/20 bg-cyan/4 px-3 py-1.5">
        ...
        <button
          ...
          aria-live="polite"
          className="rounded-[2px] border border-cyan/30 px-2 py-1.5 font-mono text-[9px] uppercase tracking-[0.15em] text-cyan/70 hover:bg-cyan/10 hover:text-cyan sm:py-0.5"
        >
          {copied ? '✓ Copied' : 'Copy'}
        </button>
      </div>
