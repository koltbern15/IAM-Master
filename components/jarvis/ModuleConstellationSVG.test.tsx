...
describe('ModuleConstellationSVG', () => {
  it('renders 12 module nodes', () => {
    const { container } = render(<ModuleConstellationSVG totalMasteryPercent={14} />)
    const nodes = container.querySelectorAll('[data-jarvis-module-node]')
    expect(nodes).toHaveLength(12)
  })

  it('renders a central mastery percent', () => {
    render(<ModuleConstellationSVG totalMasteryPercent={42} />)
